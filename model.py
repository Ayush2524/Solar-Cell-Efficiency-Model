...
def preprocess_data():
    ...
    solar_file_name = "D:\\hackathon\\Sigma\\289KW_PV_System_Hourly.csv"
    weather_file_name = "D:\\hackathon\\Sigma\\LakesideCA_Solcast_15m.txt"
...
def train_model():
    ...
    param["eval_metric"] = ["mae", "rmse","auc"]
...
def test_model():
    ...
    # Now calculate R² on scaled values
    r2 = r2_score(actual, pred)
    print(f"R_square score (scaled to Watts): {r2:.4f}")
    ...
    x=dates[: len(dates) - smoothing_step]
    y1=smooth_pred
    y2=smooth_actual
